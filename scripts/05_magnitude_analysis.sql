...
Purpose:
- Analyze the distribution and scale of business data across
different dimensions.
- Compare customers, products, countries, and categories based
on counts, averages, and revenue contribution.
...
-- Analyze the distribution of sold items across countries
SELECT
c.country,
